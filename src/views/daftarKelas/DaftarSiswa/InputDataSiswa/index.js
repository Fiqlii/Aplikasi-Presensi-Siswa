  ...
  return (
    ...
    <div className='container-lg px-4'>
      <CBreadcrumb className='breadcrumb mb-4'>
        ...
        <CBreadcrumbItem active>Input Data Siswa</CBreadcrumbItem>
      </CBreadcrumb>
      <CCard>
        <CCardBody className='px-5 mt-3'>
          <CCardTitle className='py-2 mt-3'>Input Data Siswa</CCardTitle>
          ...
          >
            <CModalHeader>
              <CModalTitle id="VerticallyCenteredExample">Menambahkan Data Siswa</CModalTitle>
            </CModalHeader>
