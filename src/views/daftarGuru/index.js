          ...
          <CTable responsive className='px-5 mt-3 text-center'>
            ...
            <CTableBody>
              <CTableRow>
                ...
                <CTableDataCell>
                  <div className="d-flex justify-content-center align-items-center" style={{ gap: '1px' }}>
                    <CButton color="warning" className="p-1 mx-1" style={{ width: '40px', height: '40px' }} as="button" href="#/editDataGuru">
